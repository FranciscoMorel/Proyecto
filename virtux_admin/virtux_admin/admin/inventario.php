	...
	<div class="card text-white bg-secondary">
			...
			<div class="card-body">
				<form action="ins_inventario.php" method="post" autocomplete="off" enctype="multipart/form-data">
					...
					<div class="form-group">
						<input type="number" min="0" name="cantidad" required placeholder="Cantidad" class="form-control">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<textarea name="descripcion" required cols="30" rows="7" class="form-control"></textarea>
					</div>
		...
		<div class="card text-white bg-dark" style="margin-top: 1%;">
				...
				<div class="card-body">
					...
					<table class="table">
						...
						<tbody>
							<?php 
							$sel = $con->prepare("SELECT * FROM inventario ORDER BY id DESC limit 3 ");
							$sel->execute();
							  	while ($f = $sel->fetch()) {  ?>
							  	<tr>
