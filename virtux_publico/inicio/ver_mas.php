...
<body class="bg-light">
  ...
  <div class="container" style="margin-top: 1%; margin-bottom: 1%;" >
    ...
    <div class="card text-white bg-secondary">
        <div class="card-header"><h1 class="card-title"><?php echo $f['producto'] ?></h1></div>
        <div class="card-body">
          <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6">
              <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="../../virtux_admin/admin/<?php echo $f['foto'] ?>" width="100%" height="70%">
                  </div>
                  <?php 
                  ...
                  <div class="carousel-item">
                    <img class="d-block w-100" src="../../virtux_admin/admin/<?php echo $f_img['ruta'] ?>" width="100%" height="70%">
                  </div>
                  <?php }
                  $sel_img = null;
                   ?>
             ...
             <div class="col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="form-group">
                  <input type="number" requred id="cantidad" class="form-control" placeholder="Cantidad"   max="<?php echo $f['cantidad'] ?>" value="1">
                </div>
    ...
    <div class="col-11">
      <div class="row">
        <div class="col-10 text-left">
          <h4 class="font-weight-bold"><?php echo $f_rating['usuario'] ?>
