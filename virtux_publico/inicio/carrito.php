...
<div class="container" style="margin-top: 10%;">
	...
	<div class="card w-100">
		<div class="card-body">
			<div class="row">
				<div class="col-4">
					<img src="../../virtux_admin/admin/<?php echo $f['foto'] ?>" width="100%" >
				</div>
				<div class="col-8">
					...
					<div class="row">
					<button type="button" class="btn btn-primary mr-5 ml-2" data-toggle="modal" data-target=".modal_mas" value="<?php echo $f['clave_producto'] ?>" onclick="modal(this.value)" >Ver mas...</button>

					<form method="post" action="eliminar_carrito.php">
		 			<button type="submit" class="btn btn-danger text-white float-right" name="btnc" value="<?php echo $f['clave'] ?>">Eliminar</button> 
		 			</form>
					</div>
				</div>
			</div>
	...
	<div class="card text-center">
		...
		<div class="card-body">
			...
			<form action="confirmacion.php" method="post" autocomplete="off">
				...
				<div class="form-group">
					<input type="text" name="colonia" placeholder="Comuna" class="form-control">
				</div>
				<div class="form-group">
